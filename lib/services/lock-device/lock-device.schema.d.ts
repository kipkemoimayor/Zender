...
export declare const lockDeviceSchema: import("@sinclair/typebox").TObject<{
...
export declare const lockDeviceValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const lockDeviceResolver: import("@feathersjs/schema").Resolver<{
    type: string;
    id: number;
    imei: string;
    loanAccountId: string;
}, HookContext>;
export declare const lockDeviceExternalResolver: import("@feathersjs/schema").Resolver<{
    type: string;
    id: number;
    imei: string;
    loanAccountId: string;
}, HookContext>;
export declare const lockDeviceDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    type: import("@sinclair/typebox").TString<string>;
    loanAccountId: import("@sinclair/typebox").TString<string>;
    imei: import("@sinclair/typebox").TString<string>;
}>, ["type", "loanAccountId", "imei"]>;
export type LockDeviceData = Static<typeof lockDeviceDataSchema>;
export declare const lockDeviceDataValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const lockDeviceDataResolver: import("@feathersjs/schema").Resolver<{
    type: string;
    id: number;
    imei: string;
    loanAccountId: string;
}, HookContext>;
export declare const lockDevicePatchSchema: import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    type: import("@sinclair/typebox").TString<string>;
    loanAccountId: import("@sinclair/typebox").TString<string>;
    imei: import("@sinclair/typebox").TString<string>;
...
export declare const lockDevicePatchValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const lockDevicePatchResolver: import("@feathersjs/schema").Resolver<{
    type: string;
    id: number;
    imei: string;
    loanAccountId: string;
}, HookContext>;
export declare const lockDeviceQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    type: import("@sinclair/typebox").TString<string>;
    loanAccountId: import("@sinclair/typebox").TString<string>;
    imei: import("@sinclair/typebox").TString<string>;
}>, ["id", "type"]>;
export declare const lockDeviceQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
...
export declare const lockDeviceQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const lockDeviceQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
