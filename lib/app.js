...
const reminder_1 = require("./jobs/reminder");
const lock_1 = require("./jobs/lock");
const unlock_1 = require("./jobs/unlock");
...
// auth
app.use('/api', middleware_1.default.validateEntry);
app.use('/api', (0, express_1.serveStatic)(app.get('public')));
app.use('/app-definition', (0, express_1.serveStatic)('./public/dev.xml'));
// Host the public folder
app.use('/docs', (0, express_1.serveStatic)('./public/templates/'));
...
(0, sync_1.syncJob)(app);
// // Handle payment and schedules
// paymentJob(app)
// reminder job
(0, reminder_1.reminderJob)(app);
(0, lock_1.lockJob)(app);
(0, unlock_1.unlockJob)(app);
(0, sendSMS_1.smsJob)(app);
